...
Combines 4 signals into a `GhostJobAssessment`:
  ...
  3. VAGUE_JD               — from the Ghost-Job JD Scorer (Haiku)
...
JD-scorer prompt below. Was an Opus xhigh call originally, downgraded
to a regex pass briefly (2026-05-22), reverted to Haiku 2026-05-23 —
the regex missed designer/creative JDs, leadership JDs without bullet
lists, and non-English-first sources. Haiku at ~$0.005 per call is
the right cost ceiling for a signal that only feeds confidence
calibration, not a hard blocker.
"""
