      ...
      <div className="border-t border-canvas bg-secondary/5 px-4 py-2 flex items-center justify-between relative z-10">
        <div className="flex gap-4">
          <div className="flex items-center gap-1.5">
             ...
             <span className="text-[8px] font-mono text-muted-foreground uppercase tracking-widest">Evidence: Profile Active</span>
          </div>
          <div className="flex items-center gap-1.5">
             <div className="w-1 h-1 rounded-full bg-success" />
