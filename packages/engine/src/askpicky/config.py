...
class Settings(BaseSettings):
    ...
    # OpenAI — strong-tier verdict, benchmark runs, and optional routing
    openai_api_key: str = ""
    ...
    # Keep disabled by default for local/dev parity; enable for public demos
    # or shared self-hosted deployments to protect local provider budgets.
