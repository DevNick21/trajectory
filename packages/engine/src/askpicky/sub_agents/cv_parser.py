"""Onboarding CV parser — DeepSeek V4 Flash structured extraction.
...
Routing: DeepSeek V4 Flash (fast tier). Structured CV
extraction is mechanical reshape, not judgement.

Untrusted input is shielded with Tier 1 regex before the agent sees
it — uploaded CVs sometimes carry recruiter-injected prompts.
"""
...
async def parse(
    *,
    ...
    """Free-form CV text → structured CVImport via DeepSeek V4 Flash.
