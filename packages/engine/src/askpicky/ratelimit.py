...
IntentCategory = Literal["forward_job", "generator", "assist", "firecrawl", "chitchat"]
...
DEFAULT_LIMITS: dict[str, Limit] = {
    ...
    "firecrawl": Limit(max_calls=30, window_s=3600.0),
...
_INTENT_CATEGORY: dict[str, IntentCategory] = {
    ...
    # Offer analysis is generator-class: it combines local PDF extraction with
    # one high-stakes LLM call.
