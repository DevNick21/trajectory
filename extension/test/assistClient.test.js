...
async function main() {
  ...
  {
    assert.equal(client.cleanApiBase("https://askpicky.com/"), "https://askpicky.com");
    assert.deepEqual(
...

  {
    ...
    assert.equal(calls[0].url, "https://askpicky.com/api/assist/start");
...

  {
    ...
    assert.equal(calls[0].url, "https://askpicky.com/api/assist/polish");
    ...
    assert.equal(calls[1].url, "https://askpicky.com/api/assist/approve");
